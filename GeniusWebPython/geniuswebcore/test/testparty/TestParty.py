...
class TestParty (DefaultParty):
    ...
    def notifyChange(self, info: Inform):
        ...
        if isinstance(info,Settings) :
            ...
            self._protocol = self._settings.getProtocol()
    ...
    def _vote(self, voting:Voting) ->Votes :
        ...
        @return our next Votes. Stupid: vote for all received offers.
        '''
        votes:Set[Vote]  = set([Vote(self._me, offer.getBid(), 2, 5)\
